        ...
        GeometryReader { geo in
            ZStack {
                ...
                Circle()
                    ...
                    .frame(width: geo.size.width * 1.5, height: geo.size.width * 0.7)
                    .offset(x: geo.size.width * 0.1, y: geo.size.height * 0.32)
                ...
                Image("Telescope")
                    ...
                    .offset(x: -geo.size.width * 0.23, y: geo.size.height * 0.23)
                ...
                VStack {
                    ...
                    Text("drowsii.")
                        ...
                        .shadow(color: Color("White").opacity(0.35), radius: 8, x: 0, y: 6)
                    Spacer()
                }
